...
function [xPosRobot, yPosRobot, angleOfRotGlobal,plot1,plot2,plot3,plot4,plot5,plot6] = location_transformation(xPos, yPos, angleOfRot)
    % INPUT
...
plotSize = 300; % determines how largethe plot is in cm
...
AxesLineWidth = 1;
AxesLineColor = ':k';
plot([-plotSize plotSize],[0 0],AxesLineColor,'linewidth',AxesLineWidth)
plot([0 0],[-plotSize plotSize],AxesLineColor,'linewidth',AxesLineWidth)
...
robotColor2 = ':b';
plot1=plot(robotPlotXGlobal,robotPlotYtopGlobal,robotColor2,'linewidth',robotLineWidth)
plot2=plot(robotPlotXGlobal,robotPlotYbottomGlobal,robotColor2,'linewidth',robotLineWidth)
plot3=plot([xPosRobot xPosRobot-robotRadius*sin(angleOfRot)],[yPosRobot yPosRobot+robotRadius*cos(angleOfRot)],robotColor2,'linewidth',robotLineWidth)
