...
% initialize liz's cool plot
[xPosGlobal, yPosGlobal, angleOfRotGlobal,plot1,plot2,plot3,plot4,plot5,plot6] = location_transformation(r(1), r(2), orientation);
...
title(num2str(orientation*180/pi))
